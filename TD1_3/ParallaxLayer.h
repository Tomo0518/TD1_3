...
class ParallaxLayer {
public:
    ParallaxLayer(TextureId textureId, float scrollSpeed, std::string layerName,float repeatWidth = 1280.0f);
	...
	std::string GetLayerNameTag() const { return layerNameTag_; }
	void SetLayerNameTag(const std::string& name) { layerNameTag_ = name; }
